...
set(SELFID_GENERATE_SCRIPT ${SELFID_CMAKE_DIRECTORY}/selfid.sh)

if(EXISTS ${SELFID_ALWAYS_RUN_ANCHOR})
    message(FATAL_ERROR "File \"${SELFID_ALWAYS_RUN_ANCHOR}\" found, it should never be created, remove!")
endif()
